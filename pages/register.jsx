...
export default function SignUpPage() {
    ...
    const handleSignUp = async () => {
        ...
        if (error) {
            toast.error('Error Signing Up, Invalid Email or Password !!', {
              duration: 3000,
              style: {
      ...
      <div className="relative flex flex-col w-full min-h-screen bg-white dark:bg-transparent ">
        ...
        <div className="absolute top-10 right-10">
          <Link href="/login">
            <button
              type="button"
              className=" text-white bg-blue-500 hover:bg-opacity-60 focus:ring-4 focus:outline-none focus:ring-cyan-300 font-medium rounded-lg text-sm px-6 py-2 text-center  dark:bg-blue-500 dark:hover:bg-opacity-70 dark:focus:ring-cyan-800"
            >
              Login
            </button>
          </Link>
